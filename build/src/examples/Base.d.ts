...
declare abstract class BaseModel<U> extends MongooseModelClass<U> {
    ...
    build(modelName?: string, connection?: Mongoose): mongoose.MongooseModelClassModel<ReturnType<this["schema"]>, import("../types").MongooseModelClassPickMatching<this, Function>, import("../types").MongooseModelClassExtractVirtuals<this>, import("../types").BeAnObject, mongoose.IfAny<ReturnType<this["schema"]>, any, mongoose.ObtainSchemaGeneric<ReturnType<this["schema"]>, "DocType">> & mongoose.MongooseModelClassTimestamps, mongoose.IfAny<mongoose.IfAny<ReturnType<this["schema"]>, any, mongoose.ObtainSchemaGeneric<ReturnType<this["schema"]>, "DocType">> & mongoose.MongooseModelClassTimestamps, any, import("../types").MongooseModelClassExtractVirtuals<this> & import("../types").MongooseModelClassPickMatching<this, Function> extends infer T ? T extends import("../types").MongooseModelClassExtractVirtuals<this> & import("../types").MongooseModelClassPickMatching<this, Function> ? T extends Record<string, never> ? mongoose.Document<unknown, import("../types").BeAnObject, mongoose.IfAny<ReturnType<this["schema"]>, any, mongoose.ObtainSchemaGeneric<ReturnType<this["schema"]>, "DocType">> & mongoose.MongooseModelClassTimestamps> & mongoose.Require_id<mongoose.IfAny<ReturnType<this["schema"]>, any, mongoose.ObtainSchemaGeneric<ReturnType<this["schema"]>, "DocType">> & mongoose.MongooseModelClassTimestamps> : mongoose.IfAny<T, mongoose.Document<unknown, import("../types").BeAnObject, mongoose.IfAny<ReturnType<this["schema"]>, any, mongoose.ObtainSchemaGeneric<ReturnType<this["schema"]>, "DocType">> & mongoose.MongooseModelClassTimestamps> & mongoose.Require_id<mongoose.IfAny<ReturnType<this["schema"]>, any, mongoose.ObtainSchemaGeneric<ReturnType<this["schema"]>, "DocType">> & mongoose.MongooseModelClassTimestamps>, mongoose.Document<unknown, import("../types").BeAnObject, mongoose.IfAny<ReturnType<this["schema"]>, any, mongoose.ObtainSchemaGeneric<ReturnType<this["schema"]>, "DocType">> & mongoose.MongooseModelClassTimestamps> & Omit<mongoose.Require_id<mongoose.IfAny<ReturnType<this["schema"]>, any, mongoose.ObtainSchemaGeneric<ReturnType<this["schema"]>, "DocType">> & mongoose.MongooseModelClassTimestamps>, keyof T> & T> : never : never>> & import("../types").MongooseModelClassPickMatching<U, Function>;
}
