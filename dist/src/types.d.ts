import { Document, HydratedDocument, InferSchemaType, Model, ObtainDocumentType, ObtainSchemaGeneric, Schema } from 'mongoose';
...
export type MongooseModelClassModel<DocType, Methods, Virtuals, Statics> = Model<DocType, object, Methods, Virtuals> & Statics;
/**
 ...
 * ```
 */
export type MongooseModelClassDocumentType<T extends {
    builtSchema: any;
}, QueryHelpers = BeAnObject> = Document<any, QueryHelpers> & InferSchemaType<T['builtSchema']>;
/**
 * Used Internally for ModelTypes
 */
export type MongooseModelClassModelType<T extends {
    builtSchema: any;
}, QueryHelpers = BeAnObject, Statics = BeAnObject, Virtuals = BeAnObject> = Model<MongooseModelClassDocumentType<T, QueryHelpers>, QueryHelpers, object, Virtuals, Statics>;
/**
 ...
 */
export type MongooseModelClassReturnModelType<ModelClass extends {
    builtSchema: any;
}, QueryHelpers = BeAnObject, Virtuals = BeAnObject, Statics = BeAnObject> = MongooseModelClassModelType<ModelClass, QueryHelpers, Virtuals, Statics> & ModelClass;
